...
public class GlobalVariables {
	...
	public static float deltaTimeConst = 0.002f;
	public const float baseAccelerator = 40;
    public static float framePerSecond = 200;
	//public const double deltaTime = 0.011313131313;
	//public const double deltaTime = 0.011111111111;
	//public const double deltaTime = 0.0056565656565;
	//public const float deltaTime = 0.022727272727f;
}
